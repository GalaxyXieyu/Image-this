...
const WATERMARK_POSITION_OPTIONS: Array<{ id: WatermarkPreset; label: string }> = [
...
const WATERMARK_POSITION_LABELS: Record<WatermarkPreset, string> = WATERMARK_POSITION_OPTIONS.reduce(
